---
name: repomix-reference-neon-oubliette
description: Reference codebase for Neon Oubliette. Use this skill when you need to understand the structure, implementation patterns, or code details of the Neon Oubliette project.
---

# Neon Oubliette Codebase Reference

283 files | 73608 lines | 700139 tokens
